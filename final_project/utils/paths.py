...
for dir_type in [
    ...
    def hello():
        print("Hello... your using a function stored in another file of this project. This came from the script 'paths' that is located inside folders: final_project / utils")